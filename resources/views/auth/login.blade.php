              ...
              <div class="card mb-3 auth-card">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2 text-center auth-logo">
                    ...
                    <h5 class="auth-title">Selamat Datang Kembali</h5>
                    <p class="auth-subtitle">Masukan datamu untuk melanjutkan perjalananmu</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="email" class="form-control border-start-0 @error('email') is-invalid @enderror" id="email" placeholder="Masukkan email Anda" required style="border-left: none;">
                        @error('email')
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="password" name="password" class="form-control border-start-0 @error('password') is-invalid @enderror" id="yourPassword" placeholder="Masukkan password Anda" required style="border-left: none;">
                        @error('password')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
                    ...
                    <div class="col-12 text-center auth-links">
                      <a class="small mb-2 d-block" href="{{ route('password.request') }}">
