...
@section('header')
    <div class="pagetitle">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/admin/kantorcabang/editbus">Edit Bus</a></li>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/admin/kantorcabang/bus/{{ $bus->id }}" method="POST" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="row mb-3">
