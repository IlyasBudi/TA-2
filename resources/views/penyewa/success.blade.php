            ...
            <div class="row my-3">
                <div class="col">
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="/bookingpage" class="btn btn-md btn-outline-dark">Booking Lagi</a>
                    </div>
                </div>
            </div>
        </div>
